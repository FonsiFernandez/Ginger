    ...
    return (
        <div className="min-h-screen w-full bg-[radial-gradient(ellipse_at_top,rgba(99,102,241,0.18),transparent_55%),radial-gradient(ellipse_at_top_right,rgba(34,197,94,0.14),transparent_50%),radial-gradient(ellipse_at_bottom_left,rgba(236,72,153,0.10),transparent_55%)]">
            <main className="w-full">
                <div className="mx-auto w-full max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-6 space-y-6">
                    ...
                    {/* TOP ROW: Form left, Weight right */}
                    <div className="grid gap-6 lg:grid-cols-12">
                        <Card className="lg:col-span-5 rounded-3xl border bg-background/60 backdrop-blur-xl shadow-sm lg:sticky lg:top-6 self-start">
                  ...
                  <span className="inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500/15 to-fuchsia-500/10 border">
                    <Target className="h-4 w-4" />
                        ...
                        <Card className="lg:col-span-7 rounded-3xl border bg-background/60 backdrop-blur-xl shadow-sm">
      ...
      <span className="inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500/15 to-lime-500/10 border">
        <TrendingUp className="h-4 w-4" />
                            ...
                            {/* IMPORTANTE: hacemos que el contenido tenga altura y layout */}
                            <CardContent className="h-[420px] sm:h-[460px] lg:h-[520px]">
                                {weightChartData.length === 0 ? (
                                    <div className="h-full rounded-2xl border bg-background/50 p-4 text-sm text-muted-foreground flex items-center">
...
function ChartShell({
    ...
    return (
        <div
            className={[
                "w-full rounded-2xl border bg-background/50 p-3",
                fill ? "h-full" : tall ? "h-72" : "h-64",
            ].join(" ")}
        >
            {children}
        </div>
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-2xl border bg-background/60">{icon}</span>
                <span>{label}</span>
            </div>
            {children}
        </div>
